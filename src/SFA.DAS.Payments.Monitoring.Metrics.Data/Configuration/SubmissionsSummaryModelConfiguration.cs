...
namespace SFA.DAS.Payments.Monitoring.Metrics.Data.Configuration
{
    public class SubmissionsSummaryModelConfiguration : IEntityTypeConfiguration<SubmissionsSummaryModel>
    {
        public void Configure(EntityTypeBuilder<SubmissionsSummaryModel> builder)
        {
            ...
            {
                amounts.Property(x => x.ContractType1).HasColumnName(@"EarningsDASContractType1").HasColumnType("decimal(15,5)");
                amounts.Property(x => x.ContractType2).HasColumnName(@"EarningsDASContractType2").HasColumnType("decimal(15,5)");
                amounts.Property(x => x.DifferenceContractType1).HasColumnName(@"EarningsDifferenceContractType1").HasColumnType("decimal(15,5)");
                amounts.Property(x => x.DifferenceContractType2).HasColumnName(@"EarningsDifferenceContractType2").HasColumnType("decimal(15,5)");
            ...
            {
                amounts.Property(x => x.ContractType1).HasColumnName(@"RequiredPaymentsContractType1").HasColumnType("decimal(15,5)");
                amounts.Property(x => x.ContractType2).HasColumnName(@"RequiredPaymentsContractType2").HasColumnType("decimal(15,5)");
                amounts.Ignore(x => x.Total);
            });
