...
{
    public class PeriodEndSummaryModelConfiguration : IEntityTypeConfiguration<PeriodEndSummaryModel>
    {
        public void Configure(EntityTypeBuilder<PeriodEndSummaryModel> builder)
        {
