...
namespace SFA.DAS.Payments.Monitoring.Metrics.Data.Configuration
{
    public class ProviderPaymentFundingSourceModelConfiguration: IEntityTypeConfiguration<ProviderPaymentFundingSourceModel>
    {
        public void Configure(EntityTypeBuilder<ProviderPaymentFundingSourceModel> builder)
        {
            ...
            builder.Property(x => x.FundingSource1).HasColumnName(@"FundingSource1").IsRequired().HasColumnType("decimal(15,5)");
            builder.Property(x => x.FundingSource2).HasColumnName(@"FundingSource2").IsRequired().HasColumnType("decimal(15,5)");
            builder.Property(x => x.FundingSource3).HasColumnName(@"FundingSource3").IsRequired().HasColumnType("decimal(15,5)");
            builder.Property(x => x.FundingSource4).HasColumnName(@"FundingSource4").IsRequired().HasColumnType("decimal(15,5)");
            builder.Property(x => x.FundingSource5).HasColumnName(@"FundingSource5").IsRequired().HasColumnType("decimal(15,5)");
